...
class LessonController extends Controller
{
    ...
    public function detailContent(Request $request) {
        ...
        $content = $contentDB->detail($request->content_id);
    ...
    public function finishContent(Request $request) {
        ...
        $create = $contentResultService->create($request->content_id, $userId, ['status' => true]);
        $detail = $contentService->detail($request->content_id);

        $payload = [
            'experience' => $detail['experience'],
        ];

        $experienceService->update($userId, $experienceId, $payload);
    ...
    public function finishActivity(Request $request) {
        ...
        $experienceService->update($user->id, $user->experience->id, $payload);
