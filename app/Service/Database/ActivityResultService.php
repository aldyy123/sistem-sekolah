...
class ActivityResultService
{
    ...
    public function detail($activityResultId)
    {
    ...
    public function create($activityId, $studentId, $payload)
    {
    ...
    public function update($activityId, $studentId, $activityResultId, $payload)
    {
        Activity::findOrFail($activityId);
        User::findOrFail($studentId);
