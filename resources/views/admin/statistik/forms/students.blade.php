<div class="body mt-2">
    ...
    <div class="row clearfix" onclick="$('#{{ request()->route('role') }}-alert').hide('fast')">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
                ...
                <input type="text" name="{{ request()->route('role') }}Last_education" class="form-control text-dark">
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
    ...
    <div class="row clearfix" onclick="$('#{{ request()->route('role') }}-alert').hide('fast')">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
                <label>Kelas</label>
                <select name="{{ request()->route('role') }}Grade" class="form-control show-tick text-dark">
        ...
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
                <label for="editDegree" class="col-form-label">Pendidikan Saat ini</label>
                <select name="{{ request()->route('role') }}Degree" class="form-control show-tick text-dark" id="editDegree">
    ...
    <div class="row clearfix">
        <div class="col-lg-6 col-md-6 col-sm-12">
            <div class="form-group">
                <label for="batch_student" class="col-form-label">Batch</label>
                <select name="{{ request()->route('role') }}Batch_student" class="form-control show-tick text-dark" id="batch_student">
                </select>
            </div>
        </div>
    </div>
