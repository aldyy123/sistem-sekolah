                                    ...
                                    <tbody>
                                        @foreach ($subjects as $key => $subject)
                                            <tr>
                                                ...
                                                <td>{{ $subject['name'] }}</td>
                                                <td>{{ $subject['teacher_details'] ? $subject['teacher_details_string'] : 'Belum dipilih' }}
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-default" title="Edit"
                                                        data-toggle="modal"
                                                        onclick="openAssignModal('{{ $subject['name'] }}', '{{ $subject['id'] }}', '{{ $subject['subject_teacher']['id'] }}', '{{ $key }}')"><i
                                                            class="icon-user"></i></button>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-sm btn-default" title="Edit"
                                                        data-toggle="modal"
                                                        onclick="openEditModal('{{ $subject['name'] }}', '{{ $subject['id'] }}')"><i
...
@section('script')
    <script>
        ...
        function openAssignModal(name, subjectId, subjectTeacherId, key) {
            ...
            // Clear existing select elements
            $('#newSelectInModal').empty();
            ...
            // Add one extra select element for new teacher selection
        ...
        function addInput(eSelect, allSelect, teacher) {
            // data dari db
