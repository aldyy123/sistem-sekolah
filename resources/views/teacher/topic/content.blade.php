    ...
    <div class="block-header">
        <div class="row clearfix mb-4">
            <div class="col-md-6 col-sm-12">
                <a href="{{ url('/subject/' . $subject_id . '/course/' . $course_id . '/topic/' . $topic_id) }}"
        ...
        <div class="d-flex justify-content-between mt-4">
            <div></div>
            <div class="d-flex">
                <button id="btn-save" onclick="updateContent()" type="button"
                    class="btn bg-blue-2 text-white mr-2 d-flex align-items-center">
                    <i class="fa fa-save mr-2"></i>Simpan
                </button>
                <button id="btn-publish" onclick="publishContent()" type="button"
        ...
        <div class="bg-white mt-3 px-3 py-4 text-dark">
            <form>
                <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="title" placeholder="Masukkan judul ulasan"
                        name="title">
                </div>
                <div class="form-group mb-3">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="number" min="0" max="100" class="form-control" id="exp"
                        placeholder="Masukkan poin untuk siswa" name="activity_exp">
                </div>
        ...
        function publishContent() {
            ...
            if ((title === '' || (estimation === '0' || estimation === '') || content === '') && status === 'PUBLISHED') {
                ...
                swal({
                    ...
                    window.location =
                        `{{ url('/subject/' . $subject_id . '/course/' . $course_id . '/topic/' . $topic_id . '/content/' . $content_id . '/publish/${status}') }}`;
                });
            } else {
                swal({
